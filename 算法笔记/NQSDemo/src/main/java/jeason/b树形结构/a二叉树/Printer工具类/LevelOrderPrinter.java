package jeason.b树形结构.a二叉树.Printer工具类;

import jeason.b树形结构.a二叉树.Printer工具类.base.*;
...
public class LevelOrderPrinter extends Printer {
	...
	public LevelOrderPrinter(BinaryTreeInfoProtocol tree) {
		super(tree);
	...
	private static class Node {
		...
		public Node(Object btNode, BinaryTreeInfoProtocol opetaion) {
