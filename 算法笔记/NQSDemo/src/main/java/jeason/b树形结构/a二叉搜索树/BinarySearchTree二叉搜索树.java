...
public class BinarySearchTree二叉搜索树 <E> implements BinaryTreeInfoProtocol {
	...
	private void preorder(Node<E> node, Visitor<E> visitor) {
		...
		visitor.stop = visitor.visit(node.element);//在前面打印节点
	...
	private void inorder(Node<E> node, Visitor<E> visitor) {
		...
		visitor.stop = visitor.visit(node.element);//在中间打印节点
	...
	private void postorder(Node<E> node, Visitor<E> visitor) {
		...
		if (visitor.stop) return;
		visitor.stop = visitor.visit(node.element);//在后面打印节点
	}
